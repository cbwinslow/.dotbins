...
# binary directory to PATH. It should be sourced in your ~/.zshrc
...
# Note: zsh uses a different initialization method than bash
...
# Initializes the starship prompt for zsh
